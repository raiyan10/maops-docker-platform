...
expected JSON body AND role=="gateway" - a bare {"status": "ok"} from some
other MAOps service listening on the same port must not be accepted as
this service's own liveness (Day 4 finding H-1). Uses http.client (not
